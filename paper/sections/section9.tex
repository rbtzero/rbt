...
\begin{figure}[t]
  ...
  \caption{Predicted ring-aperture morphology of the 3.54 keV line.  Notebook will overlay simulated XRISM data.}
  \label{fig:ring-line}
\end{figure}
...
\begin{figure}[t]
  ...
  \caption{Axial-lepton annihilation spectrum.  Notebook will plot the $e_A\bar e_A\to\gamma\gamma$ cross-section.}
